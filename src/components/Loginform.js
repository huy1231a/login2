...
import { Component } from "react";
 ...
 export default class Loginform extends Component{
    ...
    login = () =>{
     ...
     fetch("118.69.37.109:3000/auth/login", requestOptions)
       .then(response =>{
         ...
         return(
             ...
             <div className="form-inner">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="name" id="name" onChange={this.setParams}></input>
                    </div>
                    <div className="form-group">
                        <label htmlFor="password">Password:</label>
                        <input type="password" name="password" id="password" onChange ={this.setParams} ></input>
                    </div>
